...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('user_id', models.CharField(default=accounts.models.user_information.get_uuid_no_dash, editable=False, max_length=33, primary_key=True, serialize=False, unique=True, verbose_name='ユーザーID')),
